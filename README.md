...
| قابلیت | توضیح |
|---|---|
| ثبت ورود کالا | افزایش خودکار موجودی |
| ثبت خروج / حواله | کاهش موجودی با کنترل موجودی و الزام شماره حواله |
| مدیریت کالاها | تعریف نام، کد، واحد و حداقل موجودی |
| جستجوی کالا | پیدا کردن با بخشی از نام یا کد |
| مشاهده موجودی | لیست موجودی + فیلتر کم‌موجودی |
| گزارش ورود و خروج | فیلتر نوع، تاریخ، کالا، شماره سند و حواله |
| گزارش کم‌موجودی | کالاهایی که رو به اتمام هستند |
| گردش یک کالا | تاریخچه ورود/خروج همان کالا |
...
## شروع سریع (نسخه پرتابل — پیشنهادی)
