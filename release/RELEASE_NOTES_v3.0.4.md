# انباربان v3.0.4 — پرتابل ویندوز (64-bit)

## دانلود

فایل **`Anbarban-v3-Portable.zip`** را از همین Release بگیرید.
...
- پیام‌های **AnbarbanDialog** — قابل **جابه‌جایی با موس**
- UI لوکس RTL، SearchCombo، تقویم شمسی
